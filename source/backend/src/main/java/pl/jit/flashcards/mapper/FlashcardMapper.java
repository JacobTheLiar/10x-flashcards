...
public interface FlashcardMapper {
    ...
    @Mapping(source = "sourceType.value", target = "sourceType")
    FlashcardEntity fromRequestToEntity(CreateFlashcardRequest requestDto);

    @Mapping(target = "sourceType", expression = "java(pl.jit.flashcards.data.FlashcardSourceType.fromString(entity.getSourceType()))")
